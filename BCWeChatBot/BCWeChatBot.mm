...
@interface BCWeChatBot : NSObject

@end

@implementation BCWeChatBot
...
CHConstructor // code block that runs immediately upon load
{
	@autoreleasepool
	{
		...
		// this would be posted using: notify_post("lemon.com.BCWeChatBot.eventname");
		CFNotificationCenterRef darwin = CFNotificationCenterGetDarwinNotifyCenter();
		CFNotificationCenterAddObserver(darwin, NULL, ExternallyPostedNotification, CFSTR("lemon.com.BCWeChatBot.eventname"), NULL, CFNotificationSuspensionBehaviorCoalesce);
